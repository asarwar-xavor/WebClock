...
namespace GC.WebClock
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<GC_WebClockContext>(options => options.UseSqlServer(Configuration.GetConnectionString("webClockConnectionString")));
            services.AddSingleton<IXmlRepository, DataProtectionKeyRepository>();
            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<GC_WebClockContext>()
